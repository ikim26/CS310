...
class ThreeTenGraph<V extends ThreeTenGraphComponent, E extends ThreeTenGraphComponent>
	...
	public ThreeTenHashMap<V, ThreeTenHashMap<V,E>> graphMap;
	/**map for edges and the vertices it connects.*/
	public ThreeTenHashMap<E, Pair<V>> edgeMap;
	...
	public ThreeTenGraph() {
		this.graphMap = new ThreeTenHashMap<>(10);
		this.edgeMap = new ThreeTenHashMap<>(10);
	}
