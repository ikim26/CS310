...
class Simulator {
	/**
	 *  Reads in and sets up the initial train and car positions.
	 *  
	...
	public void setupInitialTrainPositions(Scanner trainScanner) {
		...
		while(trainScanner.hasNextLine()){
			...
			if(s.length() == 0){
				...
				trains.append(trainName, newTrain);
	 ...
	 *  
	 *  @param murderLocation the location of the murder
	 *  @param murderTimeStr the time of the murder
	 *  @return returns a unique list of people
	 ...
	 *  
	 *  @param murderLocation String with the name of the car the murder takes place at.
	 *  @return returns a set of potential murderers.
	 */
	 ...
	 *  @param carObj the car that we are checking
	 *  @return returns a set of people on the car
	 */
